...
\subsection{3.3 Data Not Provided}
...
\begin{itemize}[nosep]
  ...
  \item \textbf{No injections}: given the fact that real injections (both generation and demand) are a matter of confidentiality, participants will not receive any direct information about the actual generation or load values at any substation.
\end{itemize}
